...
interface FileUploadProps {
    onFileSelected?: (fileSelected: File) => void;
}
    ...
    return (
        <div style={{ width: "100%", height: "190px" }}>
            <DialogMessageBox
                ...
                meta={dialogMessage.meta}
                confirm={dialogMessage.confirm ? "Confirm" : ""}
                cancel={dialogMessage.confirm ? "Cancel" : "Dismiss"}
                onCancel={closeWindow}
                onConfirm={handleConfirm}
                visible={dialogMessage.title.length > 0}
            />
            <Snackbar
            ...
            {fileUploading ? (
                progress === 100 ? (
                    <div className="dropzone">
                        {selectedFileName} Upload completed.
                        <LinearProgress />
                    </div>
                ) : (
                    <div className="dropzone">
                    ...
                    >
                        ...
                        {isDragActive ? (
                            ...
                            <div>
                                ...
                                />
                                <p>
                                    Drag 'n' drop PNG or JPEG image files here,
